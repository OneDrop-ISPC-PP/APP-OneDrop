...
public class AddPressureRecord {
    private Integer id;
    ...
    public AddPressureRecord() {
    }

    public AddPressureRecord(Integer id, String fecha, Integer diastolica, Integer sistolica, String comentario) {
        this.id = id;
        this.fecha = fecha;
